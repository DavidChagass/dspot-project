<div>
        ...
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-1 lg:px-8" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:gap-x-12">
                <div class="flex items-center gap-x-1 text-sm/6 font-semibold text-gray-900">
                    <a href="{{ route('empresa.register') }}" class="flex items-center gap-x-1 text-sm/6 font-semibold text-gray-900 font-semibold text-gray-900">
                        <div class="flex size-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                            <!-- Ícone para o item Analytics -->
                            <i class="fa-solid fa-building text-gray-600 group-hover:text-indigo-600"></i>
                        </div>
                        Empresa
                    </a>
                </div>
                ...
                <div class="flex items-center gap-x-1 text-sm/6 font-semibold text-gray-900">
                    <a href="{{ route('gerente-register') }}" class="flex items-center gap-x-1 text-sm/6 font-semibold text-gray-900 font-semibold text-gray-900">
                        <div class="flex size-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                            <i class="fa-solid fa-user-gear text-gray-600 group-hover:text-indigo-600"></i>
                        </div>
                        Gerente
                    </a>
                </div>
    ...
    <div class="p-4">
                ...
                <table class="min-w-full bg-white table-auto text-sm md:text-base">
                    <thead>
                        <tr>
                            ...
                            <th class="py-2 px-4 border-b-2 border-gray-200 bg-gray-100 text-left text-gray-600 uppercase">
                                <a href="{{ route('gerente-register') }}">
                                    <i class="fa-regular fa-plus"></i> Registrar Gerente
                                </a>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b border-gray-200">
                                <a class="btn btn-danger" href="{{route('empresa.gerente.show', $funcionario->id )}}">
        ...
        <div id="tabProdutos" class="bg-white p-4 rounded shadow mb-4">
            ...
            <a class="mb-2 block text-blue-500 hover:text-blue-700" href="{{ route('empresa.estoque.create') }}">
                <i class="fa-regular fa-plus"></i> Criar novo estoque
            </a>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full bg-white table-auto shadow mb-4 text-sm md:text-base">
                    <thead>
                        <tr>
                            <th colspan="4" class="py-2 px-4 border-b-2 border-gray-200 bg-gray-100 text-center text-gray-600 uppercase">
                                {{ $es->nome }}
                            </th>
                            <th colspan="1" class="py-2 px-4 border-b-2 border-gray-200 bg-gray-100 text-center text-gray-600 uppercase">
                                <a href="{{ route('empresa.estoque.edit', $es->id) }}">
                                    <i class="fa-solid fa-pen-to-square"></i> Editar Estoque
                                </a>
                            </th>
                        </tr>
                    </thead>
                    <thead>
                        <tr>
                            ...
                            <th class="py-2 px-4 border-b-2 border-gray-200 bg-gray-100 text-left text-gray-600 uppercase">
                                <a href="{{route('empresa.produtos.create')}}">
